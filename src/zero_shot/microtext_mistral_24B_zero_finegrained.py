...
# Logging
logging.basicConfig(
    filename="microtext_mistral_24B_zero_finegrained.log",
    level=logging.INFO,
...
def parse_args():
    ...
    parser.add_argument('--data_path', type=str, 
                       default='../../data/conll/microtext_finegrained.conll',
                       help='Path to the input CONLL file')
    parser.add_argument('--output_dir', type=str,
                       default='../../results/microtext_mistral_24B_zero_finegrained',
